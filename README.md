...
<li>After any changes in the variables it would be best to delete the ./files dir so the script recreates the necessary files with the correct information.
