...
<li>Edit the script [line:9] remove "rem" and change localhost to a url with your .prs config file for persistance between software reloads  - - currently if you have the simple web server exe (credit to <a href="https://github.com/faustinoaq/sswws">faustinoaq</a>) in your files folder it will try to load your latest config through it - - 
