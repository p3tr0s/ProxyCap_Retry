...
<li>Edit the script [line:9] remove "rem" and change localhost to a url with your .prs config file for persistance between software reloads
<li>Run as administrator in order to delete old registry keys. - - currently if you have the simple web server exe in your files folder it will try to load your latest config through it - - 
